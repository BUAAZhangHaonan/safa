#!/usr/bin/env python3
"""Round 1 GPU 3: 2048-sample FID for e15 base (no LoRA) — direct baseline comparison."""
...
CKPT = REPO / "artifacts/checkpoints/e15_meanflow_sit_b_face_mixed_h100_resume_2400ep/last_nopretrained.pt"
...
OUT_DIR = REPO / "artifacts/r1_eval2048_e15base"
...
def main():
    ...
    print(f"[r1_eval2048_e15] running full eval (3969 samples) on e15 base")
    from safa.evaluation.runner import run_eval_from_config
    run_eval_from_config(config)
    print(f"[r1_eval2048_e15] eval done, computing FID")
    ...
    print(f"[r1_eval2048_e15] FID(2048) = {fid_value:.4f}")
    ...
    print(f"[r1_eval2048_e15] DONE, FID={fid_value:.4f} sharp={sharp_mean:.2f}")

#!/usr/bin/env python3
"""Round 3 eval for lora_target (QV+PU) checkpoint (GPU 3). 2048-sample FID."""
...
def main():
    ...
    has_lora_target = any("attn.qkv" in k and "lora_a" in k for k in state_dict) or any("attn.proj" in k and "lora_a" in k for k in state_dict)
    print(f"[eval] has lora_target (qkv/proj): {has_lora_target}")

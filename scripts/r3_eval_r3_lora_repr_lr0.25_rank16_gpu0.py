#!/usr/bin/env python3
"""Round 3 GPU 0: 2048-sample FID + Sharpness for r3_lora_repr_lr0.25_rank16_gpu0."""
...
CKPT = REPO / "artifacts/checkpoints/r3_lora_repr_lr0.25_rank16_gpu0/best.pt"
...
OUT_DIR = REPO / "artifacts/r3_eval_r3_lora_repr_lr0.25_rank16_gpu0"
...
def main():
    ...
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank16_gpu0] running full eval (3969 samples)")
    from safa.evaluation.runner import run_eval_from_config
    run_eval_from_config(config)
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank16_gpu0] eval done, computing FID")
    ...
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank16_gpu0] FID(2048) = {{fid_value:.4f}}")
    sharp_values = []
    ...
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank16_gpu0] DONE, FID={{fid_value:.4f}} sharp={{sharp_mean:.2f}}")

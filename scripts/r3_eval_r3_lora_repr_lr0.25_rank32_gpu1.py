#!/usr/bin/env python3
"""Round 3 GPU 1: 2048-sample FID + Sharpness for r3_lora_repr_lr0.25_rank32_gpu1."""
...
def main():
    ...
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank32_gpu1] running full eval (3969 samples)")
    from safa.evaluation.runner import run_eval_from_config
    run_eval_from_config(config)
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank32_gpu1] eval done, computing FID")
    ...
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank32_gpu1] FID(2048) = {{fid_value:.4f}}")
    sharp_values = []
    ...
    print(f"[r3_eval_r3_lora_repr_lr0.25_rank32_gpu1] DONE, FID={{fid_value:.4f}} sharp={{sharp_mean:.2f}}")

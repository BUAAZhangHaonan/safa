...
tmux new-session -d -s cache_e0_train "$PYTHON_BIN scripts/guarded_run.py --max-ram-fraction $MAX_RAM_FRACTION -- $PYTHON_BIN -m safa.cli.cache_e0 --config configs/cache_e0.yaml 2>&1 | tee artifacts/logs/cache_e0_train.log"
